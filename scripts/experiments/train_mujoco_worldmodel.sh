...
if [[ $DEBUG -eq 1 ]]; then
    ...
    S2_BATCH=4;  S2_STEPS=200005; S2_VAL_EVERY=30000; S2_LIMIT=1.0; S2_VAL_BATCH=2;  S2_WORKERS=4; S2_CKPT_EVERY=10000; S2_VAL_HORIZON=100
    S3_BATCH=16; S3_STEPS=200005; S3_VAL_EVERY=30000; S3_LIMIT=1.0; S3_VAL_BATCH=2;  S3_WORKERS=4; S3_CKPT_EVERY=10000; S3_VAL_HORIZON=100
    LOG_EVERY=100
    WANDB_MODE=offline
fi
